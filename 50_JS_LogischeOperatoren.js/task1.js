...
if (gradesAsNumber == 80 || gradesAsNumber > 80 && gradesAsNumber < 89 || gradesAsNumber == 89){
    console.log("You have an B!")
}if (gradesAsNumber == 70 || gradesAsNumber > 70 && gradesAsNumber < 79 || gradesAsNumber == 79){
    console.log("You have an C!")
}if (gradesAsNumber == 60 || gradesAsNumber > 60 && gradesAsNumber < 69 || gradesAsNumber == 69){
